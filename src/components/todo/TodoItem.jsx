...
const TodoItem = ({ todoObj, updateTodo, deleteTodo }) => {
  ...
  const onToggleTodo = () => {
    updateTodo(todoObj, { type: 'isCompleted', data: !todoObj.isCompleted });
  };
  const onUpdateTodo = () => {
    ...
    updateTodo(todoObj, { type: 'todo', data: todo });
    onChangeIsUpdate();
  };
          ...
          <div className="flex items-center h-full w-full">
            ...
            >
              <div
                ...
                style={!todoObj.isCompleted ? { display: 'none' } : {}}
              >
                <BsCheckLg />
              </div>
            </div>
            ...
            <div
              ...
              style={todoObj.isCompleted ? { textDecorationLine: 'line-through' } : {}}
            >
              {todoObj.todo}
            </div>
          </div>
